  ...
  return (
    <>
      <div className="border rounded-3xl border-violet-800 font-bold px-4 py-4 bg-violet-800 md:m-0">
        <p className="text-slate-100 text-5xl font-merriweather">Traffic Sign</p>
      </div>
       <div className=" flex flex-col items-end md:flex-row">
        <div className="mt-10 space-x-8 text-xl font-normal">
          <a href="#Homepage" className={classes}>Home</a>
          <a href="#Features" className={classes}>Features</a>
          <a href="#Function" className={classes}>Function</a>
